...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
    <a class="navbar-brand" href="#">CEC Club</a>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption">
            ...
            <p>A FootBall Tournament arrange by ECE Club</p>
          </div>
        </div>
  ...
  <?php
    $events="SELECT * FROM all_clubs where club_id=3";
    ...
    <div class="container-fluid">
      <div class="row flex-row flex-nowrap">
        ...
        <?php
          ...
          $events="SELECT * FROM event WHERE root_id = 3 AND publish_date > '$create_date' ";
          $event_result=mysqli_query($db,$events);
  ...
  <section id="section6" class="container " style="padding-top:100px;padding-bottom:70px">
    < <div class="">
      ...
      <a href="JoinRequest.php?id=3" class="btn btn-xxl btn-yellow">CLICK HERE FOR JOINING REQUEST</a>
  ...
  <section id="section42" class="container" style="padding-top:70px;padding-bottom:70px; width:100%;">
    ...
    <div class="container-fluid">
      <div class="row flex-row flex-nowrap">
        ...
        <?php
          $events="SELECT * FROM event WHERE root_id = 3";
          $event_result=mysqli_query($db,$events);
          if (mysqli_num_rows($event_result)>0) {
            while ($event_record=mysqli_fetch_assoc($event_result)) {
              ?>
  ...
  <section id="section7" class="noclass" style="padding-top:130px;padding-bottom:35px">
    ...
    <div class="container">
      ...
      <form id="contactForm" onsubmit="return validate()" action="ececlub.php" method="post">
